...
export const translations: Translations = {
  ...
  'welcome.description': {
    ko: '스무 가지 질문을 통해 당신의 MBTI 성격유형을 알아보세요. 솔직하고 직관적으로 답변해주시면 더 정확한 결과를 얻을 수 있습니다.',
    en: 'Twenty questions to discover your MBTI personality type. Answer honestly and intuitively for more accurate results.',
    ja: '20の質問を通してあなたのMBTI性格タイプを調べてみてください。正直かつ直感的に答えてください。',
